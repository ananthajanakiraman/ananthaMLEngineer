...
plot(train_eval_df$epoch[train_eval_df$regularizer==0.0001],train_eval_df$magnitude[train_eval_df$regularizer==0.0001],ylim=c(0,55),type = "l",col="red",xlab = "Epoch",ylab = "Magnitude")
lines(train_eval_df$epoch[train_eval_df$regularizer==0.001],train_eval_df$magnitude[train_eval_df$regularizer==0.001],ylim=c(0,55),col="blue")
lines(train_eval_df$epoch[train_eval_df$regularizer==0.01],train_eval_df$magnitude[train_eval_df$regularizer==0.01],ylim=c(0,55),col="dark green")
lines(train_eval_df$epoch[train_eval_df$regularizer==0.1],train_eval_df$magintude[train_eval_df$regularizer==0.1],ylim=c(0,55),col="orange")
lines(train_eval_df$epoch[train_eval_df$regularizer==1],train_eval_df$magnitude[train_eval_df$regularizer==1],ylim=c(0,55),col="cyan")
legend("topleft","x,y",c("1e-4","1e-3","1e-2","1e-1","1"),lty=c(1,1),lwd=c(1.5,1.5,1.5,1.5,1.5),col=c("red","blue","dark green","orange","cyan"))
...
legend("bottomright","x,y",c("1e-4","1e-3","1e-2","1e-1","1"),lty=c(1,1),lwd=c(1.5,1.5,1.5,1.5,1.5),col=c("red","blue","dark green","orange","cyan"))
